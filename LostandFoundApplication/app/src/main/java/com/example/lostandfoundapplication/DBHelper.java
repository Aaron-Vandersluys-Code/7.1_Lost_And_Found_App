...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final int DATABASE_VERSION = 4; // Version 4 selected due to various revisions made to database through my development of the app.
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 3) {
            db.execSQL("ALTER TABLE " + TABLE_NAME + " ADD COLUMN " + COLUMN_LOST_FOUND + " TEXT");
        }
    }
    ...
    public void addData(String name, String phoneNumber, String itemDescription,
                        String date, String itemLocation, String lostOrFound) {
